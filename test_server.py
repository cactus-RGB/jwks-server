...
# AI Acknowledgment:
# The complete code for this test server was generated by Claude AI.
# I provided detailed prompts describing the required functionality,
# expected behavior, and structure of the test environment.
# No manual edits were made beyond formatting or integration with my setup.
